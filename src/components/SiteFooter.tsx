        ...
        <div>
          ...
          <div className="mt-6 flex gap-3">
            <a
              ...
              className="flex h-9 w-9 items-center justify-center border border-[rgba(45,212,191,0.3)] text-white/50 transition-all duration-300 hover:border-[color:var(--gold)] hover:text-[color:var(--gold)]"
            >
